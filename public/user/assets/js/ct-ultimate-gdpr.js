            ...
            popup_options: {
                ...
                cookies_groups: {
                    group_1: {
                        ...
                        blocked_url: 'List of blocked external cookies', // array list of url blocked scripts
                        local_cookies_name: "List of blocked local cookies", // array, list of local cookies names
                    },
                    group_2: {
                        name: 'Group name', // string: name
                        enable: "Enable this group?", // true, false, you can disable this group by using false
    ...
    $.extend(Plugin.prototype, {
                        ...
                        if (data.result.error){
                            ...
                            if (localCookies.length > 0) {
                                ...
                                localCookies.forEach(function (element) {
                                    ...
                                    for (var key in confValue) {
                                        $select.append('<option data-key="popup_options" data-key2="cookies_groups" data-key3="' + key + '" data-key4="local_cookies_name" data-keyNumbers="4">' + key + '</option>');
                                    }
                            ...
                            if (externalCookies.length > 0) {
                                ...
                                externalCookies.forEach(function (element) {
                                    var $listElement = $('<li>' + element['domain'] + '</li>');
                                    var $select = $('<select></select>');
                                    for (var key in confValue) {
                                        $select.append('<option data-key="popup_options" data-key2="cookies_groups" data-key3="' + key + '" data-key4="blocked_url" data-keyNumbers="4">' + key + '</option>');
                                    }
                                    $listElement.append($select);
                                    $cookieList.append($listElement);
                                });
        ...
        thirdForm: function () {
            ...
            for (var key in confStyle) {
                ...
                } else if (key !== 'cookies_groups' && key != 'countries_prefixes' ) {
            ...
            aop.around({target: myTarget, method: myMethod},
                ...
                function (invocation) {
                    ...
                    if (self.checkCookie('gdprPlugin') === 'true' && groupedPlugin) {
                        ...
                        if ((cookiesAllowed.indexOf(invocation.arguments[0].src) >= -1)) {
        ...
        preventForms: function () {
            ...
            $(function () {
                ...
                $allForms.each(function () {
                    var $formCheckbox = $('<div class="form-group ct-ultimate-gdpr-form-block"><label for="ct-ultimate-gdpr-form-blockInput">' + formsOptions.prevent_forms_text + '</label><input type="checkbox" class="ct-ultimate-gdpr-form-blockInput" name="ct-ultimate-gdpr-form-blockInput" required style="margin-left: 10px;"></div>');
        ...
        popUpBox: function () {
            ...
            // variebles
            var self = this;
            var popup = $('<div id="ct-ultimate-gdpr-cookie-popup"></div>');
            var popupOptionStyle = self.settings.popup_style;
            var popupOptions = self.settings.popup_options;
        ...
        popupModal: function () {
            ...
            var $popupModal = $('<div id="ct-ultimate-gdpr-cookie-modal"><div class="ct-ultimate-gdpr-cookie-modal-content"><div id="ct-ultimate-gdpr-cookie-modal-close"><span class="fas fa-times fa-2x" aria-hidden="true"></span></div><div id="ct-ultimate-gdpr-cookie-modal-body">' + popupOptions.content_before_slider + '</div></div></div>');
        ...
        modalEvents: function () {
            ...
            $('#ct-ultimate-gdpr-cookie-change-settings').on("click", function (e) {
                ...
                self.html.addClass("cookie-modal-open");
                e.stopPropagation();
            });
            ...
            $('#ct-ultimate-gdpr-cookie-modal-close').on('click', function () {
                ...
                self.html.removeClass("cookie-modal-open");
            });
