                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        <th> Banner </th>
                                        <td><img src="{{ ($article && $article->description_banner) ? asset('storage/admin/article/'.$article->description_banner) : asset('admin/default/default-avatar.png') }}" class="" width="150" style="object-fit: fill; width: 650px; height: 250px" /> </td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
