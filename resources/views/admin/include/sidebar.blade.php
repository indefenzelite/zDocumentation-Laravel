    ...
    <div class="sidebar-content">
        <div class="nav-container">
            ...
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                {{-- @if(auth()->user()->isAbleTo('access_by_admin')) --}}
                    ...
                    {{-- @if(auth()->user()->isAbleTo('manage_manage'))
                        @if(getSetting('payout_activation') == 1)
                            <div class="nav-item {{ activeClassIfRoutes(['admin.payouts.index','admin.payouts.show','admin.orders.invoice','admin.orders.create' ], 'active open')  }} has-sub">
                                <a href="#"><i class="ik ik-layers"></i><span>{{ __('Vendor')}}</span></a>
                                <div class="submenu-content">
                                    @if(getSetting('payout_activation') == 1)
                                    <a href="{{route('admin.payouts.index')}}" class="menu-item a-item {{ activeClassIfRoutes(['admin.payouts.index', 'admin.payouts.edit'], 'active')  }}">{{ __('Payouts')}}</a>
                                    @endif
                                </div>
                            </div>
                        @endif    
                    @endif --}}
                    {{-- @if(auth()->user()->isAbleTo('manage_administrator')) --}}
                    ...
                    {{-- @endif    --}}
                    {{-- @if(auth()->user()->isAbleTo('manage_resources')) --}}
                        ...
                        @endif    
                    {{-- @endif --}}
                    {{-- @if(auth()->user()->isAbleTo('mange_constant_management')) --}}
                    ...
                    {{-- @endif --}}
                    {{-- @if(auth()->user()->isAbleTo('manage_website_setup')) --}}
                        {{-- <div class="nav-item {{ activeClassIfRoutes([ 'admin.appearance',],'active open' ) }} has-sub">
                            <a href="#"><i class="ik ik-monitor"></i><span>{{ __('Website Setup')}}</span></a>
                            <div class="submenu-content">
                                
                            </div>
                        </div>  --}}
                                    {{-- <a href="{{route('admin.website-pages.appearance')}}" class="menu-item a-item {{ activeClassIfRoute('admin.website-pages.appearance', 'active')  }}">{{ __('Appearance')}}</a> --}}
                    {{-- @endif --}}
                    {{-- @if(auth()->user()->isAbleTo('manage_setup_configuration')) --}}
