<table  class="table data_table">
    ...
    <tbody>
        @foreach ($lead->userNotes as $index => $userNote)
            <tr>
                <td class=""> 
                    <div class="dropdown d-flex">
                        ...
                        @if(auth()->user()->isAbleTo('edit_note'))
                        ...
                        @endif
                        @if(auth()->user()->isAbleTo('delete_note'))
                            <li class="dropdown-item p-0"><a href="{{ route('admin.user-notes.destroy',$userNote->id) }}" title="Delete Notes" class="btn btn-sm delete-item">Delete</a></li>
                        @endif
                    </ul>
                    </div>        
                </td>
