...
<div class="side-slide" style="right: -100%;">
    <div class="filter">
        ...
        <div class="card-body">
            <form action="{{ route('admin.orders.index') }}" method="GET" id="TableForm" class="d-flex">
                <div class="row">
                    <div class="col-12 form-group">
                        <label for="">Users</label>
                        <select name="user" id="" class="form-control getUsersList" data-placeholder="All Users">
