            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Update {{$user_subscription->user->full_name}} Subscription</h5>
            ...
            <div class="col-md-5 mx-auto">
               ...
               @include('admin.include.message')
                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.user-subscriptions.update',$user_subscription->id) }}" method="post" enctype="multipart/form-data" id="UserSubscriptionForm">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12"> 
                                    <div class="form-group {{ $errors->has('from_date') ? 'has-error' : ''}}">
                                        ...
                                        <input required  class="form-control" name="from_date" type="date" id="from_date" value="{{ now()->format('Y-m-d') }}" min="{{ now()->format('Y-m-d') }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12"> 
                                    <div class="form-group {{ $errors->has('to_date') ? 'has-error' : ''}}">
                                        ...
                                        <input required  class="form-control" name="to_date" type="date" id="to_date" value="{{old('to_date','')}}" min="{{ now()->format('Y-m-d') }}">
                                    </div>
                                </div>
