...
<div class="side-slide" style="right: -100%;">
    <div class="filter">
        ...
        <div class="card-body">
            <form action="{{ route('admin.wallet-logs.index',$id) }}" method="GET" id="TableForm" class="d-flex">
                <div class="row">
                    <div class="col-12 form-group">
                        <label for="">Status</label>
                        <select class="form-control select2 w-130" name="status" id="">
                            <option aria-readonly="true" value="">Select Status</option>
                    ...
                    <div class="col-12">
                        ...
                        <a href="javascript:void(0);" id="reset" data-url="{{ route('admin.wallet-logs.index',$id) }}" type="button" class="btn btn-light ml-2">Reset</a>
                    </div> 
                </div>
            </form>
        </div>
