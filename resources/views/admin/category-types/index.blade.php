        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="d-flex justify-content-right">
                            <form action="{{ route('admin.category-types.index') }}" class="d-flex" method="GET"
                                id="TableForm">
                                <div class="dropdown">
                                    @if (auth()->user()->isAbleTo('add_category'))
                                        <a href="{{ route('admin.category-types.create') }}"
                                            class="btn btn-icon btn-sm btn-outline-primary" title="Add new Category"><i
                ...
                <div id="ajax-container">
                    @include('admin.category-types.load')
                </div>
            </div>
        </div>
...
@push('script')
    ...
    @include('admin.include.more-action', [
    ...
    <script>
        $('#reset').click(function() {
            fetchData("{{ route('admin.category-types.index') }}");
            window.history.pushState("", "", "{{ route('admin.category-types.index') }}");
