              ...
              <div data-uk-navbar="" class="uk-navbar">
                ...
                <div class="uk-navbar-center uk-hidden@m" style=" left:40px ">
                  <a class="uk-navbar-item uk-logo" href="index.html">
                    <img src="" style="width: 43%">
                  </a>
                </div>
                <div class="uk-navbar-right">
                  <div>
                    <a id="search-navbar-toggle" type="submit" class="uk-navbar-toggle searchBtn text-danger uk-icon uk-search-icon" data-uk-search-icon="" href="#" aria-expanded="false"><svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" data-svg="search-icon"><circle fill="none" stroke="#000" stroke-width="1.1" cx="9" cy="9" r="7"></circle><path fill="none" stroke="#000" stroke-width="1.1" d="M14,14 L18,18 L14,14 Z"></path></svg></a>
