                ...
                @if(isset($headerSearch))
                    <div>
                      ...
                      <div class="uk-background-default uk-border-rounded @if(request()->get('search')) uk-open  @else uk-drop @endif"  data-uk-drop="mode: click; pos: left-center; offset: 0">
                        <form action="s=" class="uk-search uk-search-navbar uk-width-1-1" method="GET">
                  ...
                  <ul class="uk-navbar-nav uk-visible@m">
                    <li>
                      <div class="uk-navbar-item" style="position: relative">
                        @if (auth()->check())
                          <a class="uk-button uk-button-primary-outline" target="_blank" href="x')}}">Dashboard</a> 
                        @else
                          <a class="uk-button uk-button-primary-outline" target="_blank" href="n')}}">Sign In</a> 
                        @endif
                      </div>
                    </li>
                    <li class="mt-4"><button type="button" class="btn btn-light translateModal" data-bs-toggle="modal" data-bs-target="#exampleModal">
