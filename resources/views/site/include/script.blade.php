     ...
     <script src="{{asset('site/assets/libs/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
     <script src="{{ asset('admin/plugins/select2/dist/js/select2.min.js') }}"></script>
     <script src="{{asset('site/assets/libs/feather-icons/feather.min.js')}}"></script>
     <!-- Main Js -->
     <script src="{{asset('site/assets/js/plugins.init.js')}}"></script>
     <script src="{{asset('site/assets/js/app.js')}}"></script>
     <script src="{{asset('site/assets/libs/tiny-slider/min/tiny-slider.js')}}"></script>
