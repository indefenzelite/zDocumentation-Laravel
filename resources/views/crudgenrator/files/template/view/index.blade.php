                                ...
                                <div class="d-flex justify-content-right">
                                    ...
                                    {{ $data['atsign'] }}endif @isset($data['export_btn'])
                                        <a href="{{ $data['curlstart'] }} route('{{ $data['dotroutepath'] . $data['view_name'] }}.export') }}"
                                            class="btn btn-icon btn-sm btn-outline-success ml-2"
                                            title="Export {{ $heading }}"><i class="fa fa-download"
                                                aria-hidden="true"></i></a>
                                        @endisset @isset($data['import_btn'])
                                        <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-outline-secondary ml-2"
                            ...
                            <div class="">
                                <select name="action" class=" form-control select-action ml-2" id="action">
                                    ...
                                    @foreach ($data['fields']['name'] as $index => $item)
                                        @if ($data['fields']['input'][$index] == 'boolean')
