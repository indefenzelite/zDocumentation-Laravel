            ...
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md">
                                <div class="form-group">
                                    ...
                                    <select name="view_path" class="form-control" id="view_path">
                                        ...
                                        <option value="{{ strtolower(str_replace(' ','-',$role->name)) }}" {{ old('view_path') == strtolower(str_replace(' ','-',$role->name)) ? 'selected' : '' }}>{{ strtolower(str_replace(' ','-',$role->name)) }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-12 col-md-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" value="{{ old('controller_namespace') ?? 'Admin' }}" id="controller-namespace" class="form-control first-upper" name="controller_namespace" id="controller_path_preview">
                                </div>
                            </div>
                        </div>
                       </div>
                    ...
                    <div class="card text-white bg-primary mb-3">
                        ...
                        <div class="card-body">
                            <small><strong>Note:</strong> When you select "Select via table" and the "Category" Table, it will take the name of the "level 1 category", and you must type the name of the "Category Type." (If that name is not in our DB then system will automatically create one based on the name you entered.)</small>
                            <div class="row mt-2">
                                <div class="col ml-5">
                                    Name
                                </div>
                            ...
                            <ul id="sortable" class="fields p-0">
                                <li class="row no-gutters ui-state-default align-items-center field">
                                    ...
                                    <div class="col">
                                        ...
                                        <label title="To ensure that multiple values can be entered into the field. (files & select)">
                                        <input type="checkbox" class="ml-2" {{ (old('fields') && @old('fields')['options']['multiple_0'] ) ? 'checked' : ""}} name="fields[options][multiple_0]" value="multiple" disabled id="multiple_0"> Multiple </label>
                                    ...
                                    <div class="col-12 justify-content-around d-none" id="cascadediv0">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="fields[ref_table][0]" class="form-control d-inline-flex" value="" placeholder="Enter table name" value="{{ (old('fields') && @old('fields')['ref_table'][0]) ? @old('fields')['ref_table'][0]: ''}}">
                                        </div>
                                        <div class="mt-4">Enter Ref Column Name</div>
                                        <div class="form-group">
                                            <input type="text" name="fields[ref_col][0]" class="form-control d-inline-flex" value="id" placeholder="Enter column name" value="{{ (old('fields') && @old('fields')['ref_col'][0]) ? @old('fields')['ref_col'][0] : ''}}">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        @isset(old('fields')['name'][$i])
                                            <li class="row no-gutters ui-state-default align-items-center field">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <input type="checkbox" class="ml-2" name="fields[options][multiple_{{ $i }}]" value="multiple" {{ (old('fields') && @old('fields')['options']['multiple_'.$i] ) ? 'checked' : "disabled"}}  id="multiple_{{ $i }}"> Multi <small>(files & select)</small>    </label>    
                                                </div>
                                                <div class="col">
                                                    <div class="form-group d-flex justify-content-around">
                                                ...
                                                <div class="col-12 justify-content-around  {{ (old('fields') && @old('fields')['options']['cascade_'.$i] ) ? 'd-md-flex' : "d-none"}} " id="cascadediv{{ $i }}">
                                                    <div class="mt-4">Enter Ref Table Name (PhpMyAdmin)</div>
                                                    <div class="form-group">
                                                        <input type="text" name="fields[ref_table][{{ $i }}]" class="form-control d-inline-flex" placeholder="Enter table name" value="{{ (old('fields') && @old('fields')['ref_table'][$i]) ? @old('fields')['ref_table'][$i] : '' }}">
                                                    </div>
                                                    <div class="mt-4">Enter Ref Column Name</div>
                                                    <div class="form-group">
                                                        <input type="text" name="fields[ref_col][{{ $i }}]" class="form-control d-inline-flex" placeholder="Enter column name" value="{{ (old('fields') && @old('fields')['ref_col'][ $i]) ? @old('fields')['ref_col'][ $i]:''}}">
                                                    </div>
                                                    <div class="form-group">
                                                        <label title="On Delete.">
                        ...
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col text-center">
                                    ...
                                    <label for="export_btn"><input type="checkbox" id="export_btn" name="export_btn" value="1" @if(old('export_btn') == 1) checked  @endif />Export</label><br>
                                    <label for="bulk_activation_btn"><input type="checkbox" id="bulk_activation_btn" name="bulk_activation_btn" value="1" @if(old('bulk_activation_btn') == 1) checked  @endif />Export</label><br>
                                </div>
                                <div class="col text-center">
                                    ...
                                    <label for="import_btn"><input type="checkbox" id="import_btn" name="import_btn" value="1" @if(old('import_btn') == 1) checked  @endif />Import</label><br>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                @if(old('media') && count(old('media')['name']) > 0)
                                    @for($i = 1; $i <= count(old('media')['name']); $i++)
                                        <li class="row no-gutters ui-state-default align-items-center field">
                                            ...
                                            <div class="col">
                                                <div class="form-group mr-1">
                                                    <input type="number" class="form-control" value="{{ (old('media') && old('media')['col'][$i] ) ? old('media')['col'][$i] : ""}}" data-id="{{ $i }}" id="media_col{{ $i }}" name="media[col][{{ $i }}]" placeholder="Enter col-md" min="1" max="12" />
                                                </div>
                                                <label title="To ensure that null values are multiple.">
                                                    <input type="checkbox" class="ml-2" {{ (old('media') && @old('media')['options']['multiple_'.$i] ) ? 'checked' : ""}} name="media[options][multiple_{{ $i }}']" value="multiple" id="media-multiple_{{ $i }}"> multi
                                                </label>
                                            </div>
                                        </li>
                                    @endfor
    ...
    <script>
            ...
            if(text.includes('_id') || text.includes('_by')){
                ...
                let value = @json($tmpFiles).filter(function(obj) {
                   ...
                   $this.closest('.field').find('[name="fields[table]['+col_id+']"] [value="'+value[0]+'"]').attr('selected', 'selected');
                    if(value == "Category")
                    $this.closest('.field').find('[name="fields[comment][0]"]').attr('placeholder','Enter Category Type Name');
                    else
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#addValidations', function () {
                ...
                let tmp =   '<div class="row no-gutters align-items-center validation">\n' +
                            '    <div class="col">\n' +
                            '        <div class="form-group mr-1">\n' +
            ...
            $(document).on('click', '#addFieldsBtn', function () {
                ...
                let tmp =   '<li class="row no-gutters ui-state-default align-items-center field">\n' +
                    ' <span class="btn-accent btn-sm mr-3 hash">#</span>'+
                            ...
                            ' <label title="To ensure that multiple values can be entered into the field.">   <input type="checkbox" class="ml-2" name="fields[options][multiple_'+iteration+']" value="multiple" disabled id="multiple_'+iteration+'"> Multi <small>(files & select)</small></label>'+
                            '    </div>\n' +
                                '<div class="col">\n' +
                                    '<div class="form-group d-flex justify-content-around">\n '+
                                        html
                    ...
                    ' <span class="btn-accent btn-sm mr-3 hash">#</span>'+
                            ...
                            ' </div>'+
                                '<div class="col">'+
                                    ...
                                    ' </div>'+
                            '      <label title="To ensure ascending descending sorting can be performed.">  <input type="checkbox" class="ml-2 do-sorting" name="media[options][multiple_'+mediaIteration+']" value="multiple" id="media-multiple_'+mediaIteration+'"> Multi<label>'+
                            '    </div>\n' +
                            '</li>';
            ...
            function convertWord(word) {
                ...
                var ucwords = replacedDashes.replace(/(^|\s)\S/g, function(t) { return t.toUpperCase(); });
