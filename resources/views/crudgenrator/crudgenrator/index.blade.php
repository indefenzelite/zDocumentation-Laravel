                ...
                <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md">
                                <div class="form-group">
                                    ...
                                    <select name="view_path" class="form-control" id="view_path">
                                      <option value="panel" {{ old('view_path') == 'panel' ? 'selected' : '' }}>panel</option>
                                      <option value="admin" {{ old('view_path') == 'admin' ? 'selected' : '' }}>admin</option>
                                      <option value="user" {{ old('view_path') == 'user' ? 'selected' : '' }}>user</option>
                                    </select>
                            ...
                            <div class="col-12 col-md-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" value="{{ old('controller_namespace') ?? 'Panel' }}" class="form-control first-upper" name="controller_namespace" id="controller_path_preview">
                    ...
                    <div class="card text-white bg-primary mb-3">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div>
                                <button class="btn btn-accent btn-sm btn-add" type="button" title="Add New Field" id="addFieldsBtn">+</button>
                                <button class="btn btn-accent btn-sm btn-sub" type="button" title="Last Field Delete" id="removeFieldsBtn">-</button>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row mb-2">
                                ...
                                <li class="row no-gutters ui-state-default align-items-center field">
                                    ...
                                    <div class="col">
                                        <div class="form-group mr-1">
                                            <input required type="text" class="form-control col_name" value="{{ (old('fields') && old('fields')['name'][0] ) ? old('fields')['name'][0] : ""}}" data-id="0" id="col_name0" name="fields[name][0]" placeholder="Name" />
                                        </div>
                                        <label title="To ensure the field is required from both the client and server sides, this is helpful.">
                                            <input type="checkbox" class="ml-2 do-required"  {{ (old('fields') && @old('fields')['options']['required_0'] ) ? 'checked' : ""}} name="fields[options][required_0]" value="required" id="required_0"> Required
                                        </label>
                                        <label title="To ensure that null values are accepted.">
                                            <input type="checkbox" class="ml-2 do-nullable" {{ (old('fields') && @old('fields')['options']['required_0'] ) ? '' : "checked"}} name="fields[options][nullable_0]" value="nullable" id="nullable_0"> Null
                                        </label>
                                        <label title="To ensure ascending descending sorting can be performed.">
                                            <input type="checkbox" class="ml-2 do-sorting" {{ (old('fields') && @old('fields')['options']['sorting_0'] ) ? 'checked' : ""}} name="fields[options][sorting_0]" value="sorting" id="sorting_0"> Sort
                                        </label>
                                    </div>
                                    <div class="col">
                                        <div class="form-group mr-1 setDataType">
                                            <select required name="fields[type][0]" class="form-control select2 " id="">
                                        ...
                                        <label title="To ensure that the field is displayed in the table.">
                                            <input type="checkbox" class="ml-2" {{ (old('fields') && @old('fields')['options']['showindex_0'] ) ? 'checked' : ""}}  name="fields[options][showindex_0]" value="showindex"  id="showindex_0">Index
                                        </label>
                                        <label title="To ensure that the field is searchable in the table.">
                                            <input type="checkbox" class="ml-2" {{ (old('fields') && @old('fields')['options']['cansearch_0'] ) ? 'checked' : ""}} name="fields[options][cansearch_0]" value="cansearch" id="cansearch_0">Search
                                        </label>
                                        <label title="To ensure that the record is delete in that table if the reference table record delete.">
                                            <input type="checkbox" class="ml-2" title="To ensure that the record is delete in that table if the reference table record delete." name="fields[options][cascade_0]" {{ (old('fields') && @old('fields')['options']['cascade_0'] ) ? 'checked' : "disabled"}} value="cascade" id="cascade_0" >Cascade    
                                        </label>
                                    </div>
                                    <div class="col">
                                        <div class="form-group mr-1">
                                            <select required name="fields[input][0]" class="form-control select2 fields-type">
                                        ...
                                        <label title="To ensure that the field accepts unique values from the database.">
                                            <input type="checkbox" class="ml-2 do-unique" {{ (old('fields') && @old('fields')['options']['unique_0'] ) ? 'checked' : ""}} name="fields[options][unique_0]" value="unique" id="unique_0"> Unique
                                        </label>
                                        <label title="To ensure that multiple values can be entered into the field.">
                                        <input type="checkbox" class="ml-2" {{ (old('fields') && @old('fields')['options']['multiple_0'] ) ? 'checked' : ""}} name="fields[options][multiple_0]" value="multiple" disabled id="multiple_0"> Multiple <small>(files & select)</small></label>
                                     </div>
                                    <div class="col">
                                        <div class="form-group d-flex justify-content-around">
                                            <textarea name="fields[default][0]" rows="1"  class="form-control @if(old('fields') && old('fields')['table'][0] != "") d-none @endif">{{  (old('fields') && old('fields')['default']['0'] ) ?  old('fields')['default']['0'] : "" }}</textarea>
                                            <select name="fields[table][0]" class="form-control table @if(old('fields') && old('fields')['table'][0] != "")  @else d-none @endif">
                                        ...
                                        <label title="Your form contains this field in a quarter of a row.">
                                            <input type="checkbox" class="ml-2 export" {{ (old('fields') && @old('fields')['options']['export_0'] == 'export' ) ? 'checked' : ""}} name="fields[options][export_0]" value="export" id="export_0"> export
                                        </label>
                                        <label title="Your form contains this field in a quarter of a row.">
                                            <input type="checkbox" class="ml-2 import" {{ (old('fields') && @old('fields')['options']['import_0'] == 'import' ) ? 'checked' : ""}} name="fields[options][import_0]" value="import" id="import_0"> import
                                        </label>
                                        <label title="Your form contains this field in a quarter of a row.">
                                            <input type="checkbox" class="ml-2 column" {{ (old('fields') && @old('fields')['column']['column_0'] == 'col-md-3' ) ? 'checked' : ""}} name="fields[column][column_0]" value="col-md-3" id="column_0"> md-3
                                        </label>
                                        
                                    </div>
                                    <div class="col">
                                        <div class="form-group ml-1">
                                            <input  type="text" class="form-control d-inline-flex" value="{{ (old('fields') && old('fields')['comment'][0] ) ? old('fields')['comment'][0] : ""}}" name="fields[comment][0]" placeholder="Comment" />
                                        </div>
                                        <label title="Your form contains this field in a one-third of a row.">
                                            <input type="checkbox" class="ml-2 column" {{ (old('fields') && @old('fields')['column']['column_0'] == 'col-md-4' ) ? 'checked' : ""}} name="fields[column][column_0]" value="col-md-4" id="column_0"> md-4
                                        </label>
                                        <label title="Your form contains this field in a half of a row.">
                                        <input type="checkbox" class="ml-2 column" {{ (old('fields') && @old('fields')['column']['column_0'] != 'col-md-6' ) ? '' : "checked"}}  name="fields[column][column_0]" value="col-md-6" id="column_0"> md-6 </label>
                                        <label title="Your form contains this field in a full row.">
                                        <input type="checkbox" class="ml-2 column" {{ (old('fields') && @old('fields')['column']['column_0'] == 'col-md-12' ) ? 'checked' : ""}} name="fields[column][column_0]" value="col-md-12" id="column_0"> md-12<label>
                                    </div>
                                    <div class="col-12 justify-content-around d-none" id="cascadediv0">
                                        <div class="mt-4">Enter Ref Table Name (PhpMyAdmin)</div>
                                        <div class="form-group">
                                            <input type="text" name="fields[ref_table][0]" class="form-control d-inline-flex" value="" placeholder="Enter table name" value="{{ old('fields') && @old('fields')['ref_table'][0]}}">
                                        </div>
                                        <div class="mt-4">Enter Ref Column Name</div>
                                        <div class="form-group">
                                            <input type="text" name="fields[ref_col][0]" class="form-control d-inline-flex" value="id" placeholder="Enter column name" value="{{ old('fields') && @old('fields')['ref_col'][0]}}">
                                        </div>
                                        <div class="form-group">
                                            <label title="On Delete.">
                                            <input type="checkbox" class="ml-2 " {{ (old('fields') && @old('fields')['ref_on_delete_0'] == 'OnDelete' ) ? 'checked' : ""}} name="fields[ref_on_delete_0]" value="OnDelete" id="ref_on_delete_0" checked> OnDelete<label>
                                        </div>
                                        <div class="form-group">
                                            <label title="On update">
                                                <input type="checkbox" class="ml-2 " {{ (old('fields') && @old('fields')['ref_on_update_0'] == 'OnUpdate' ) ? 'checked' : ""}} name="fields[ref_on_update_0]" value="OnUpdate" id="ref_on_update_0"checked> OnUpdate<label>
                                        </div>
                                    </div>
                                </li>
                                @if(old('fields') && count(old('fields')['name']) > 0)
                                    @for($i = 1; $i<count(old('fields')['name']); $i++)
                                        <li class="row no-gutters ui-state-default align-items-center field">
                                            ...
                                            <div class="col">
                                                <div class="form-group mr-1">
                                                    <input required type="text" class="form-control col_name" value="{{ (old('fields') && old('fields')['name'][$i] ) ? old('fields')['name'][$i] : ""}}" data-id="{{ $i }}" id="col_name{{ $i }}" name="fields[name][{{ $i }}]" placeholder="Name" />
                                                </div>
                                                <label  title="To ensure the field is required from both the client and server sides, this is helpful.">
                                                    <input type="checkbox" class="ml-2 do-required" name="fields[options][required_{{ $i }}]" value="required" {{ (old('fields') && @old('fields')['options']['required_'.$i] ) ? 'checked' : ""}} id="required_{{ $i }}"> Required
                                                </label>
                                                <label title="To ensure that null values are accepted.">
                                                    <input type="checkbox" class="ml-2 do-nullable" title="To ensure that null values are accepted." name="fields[options][nullable_{{ $i }}]" value="nullable" {{ (old('fields') && @old('fields')['options']['nullable_'.$i] ) ? 'checked' : ""}} id="nullable_{{ $i }}"> Null
                                                </label>
                                                <label title="To ensure ascending descending sorting can be performed.">
                                                    <input type="checkbox" class="ml-2 do-sorting" title="To ensure ascending descending sorting can be performed." name="fields[options][sorting_{{ $i }}]" {{ (old('fields') && @old('fields')['options']['sorting_'.$i] ) ? 'checked' : ""}} value="sorting" id="sorting_{{ $i }}"> Sort
                                                </label>
                                            </div>
                                            <div class="col">
                                                <div class="form-group mr-1">
                                                    <select required name="fields[type][{{ $i }}]" class="form-control select2">
                                                        <option value="">--Select Field Type--</option>
                                                ...
                                                <label title="To ensure that the field is displayed in the table.">
                                                    <input type="checkbox" class="ml-2"  name="fields[options][showindex_{{ $i }}]" value="showindex" {{ (old('fields') && @old('fields')['options']['showindex_'.$i] ) ? 'checked' : ""}} id="showindex_{{ $i }}">Index
                                                </label>
                                                <label title="To ensure that the field is searchable in the table.">
                                                    <input type="checkbox" class="ml-2" title="To ensure that the field is searchable in the table." name="fields[options][cansearch_{{ $i }}]" {{ (old('fields') && @old('fields')['options']['cansearch_'.$i] ) ? 'checked' : ""}} value="cansearch" id="cansearch_{{ $i }}">Search    
                                                </label>    
                                                <label title="To ensure that the record is delete in that table if the reference table record delete.">
                                                    <input type="checkbox" class="ml-2" title="To ensure that the record is delete in that table if the reference table record delete." name="fields[options][cascade_{{ $i }}]" {{ (old('fields') && @old('fields')['options']['cascade_'.$i] ) ? 'checked' : "disabled"}} value="cascade" id="cascade_{{ $i }}" >Cascade    
                                                </label>    
                                            </div>
                                            <div class="col">
                                                <div class="form-group mr-1">
                                                    <select required name="fields[input][{{ $i }}]" class="form-control select2 fields-type">
                                                        <option value="">--Select Input Type--</option>
                                                ...
                                                <label title="To ensure that the field accepts unique values from the database.">
                                                    <input type="checkbox" class="ml-2 do-unique" title="To ensure that the field accepts unique values from the database." name="fields[options][unique_{{ $i }}]" {{ (old('fields') && @old('fields')['options']['unique_'.$i] ) ? 'checked' : ""}} value="unique" id="unique_{{ $i }}"> Unique
                                                </label>
                                                <label title="To ensure that multiple values can be entered into the field.">
                                                <input type="checkbox" class="ml-2" name="fields[options][multiple_{{ $i }}]" value="multiple" {{ (old('fields') && @old('fields')['options']['multiple_'.$i] ) ? 'checked' : "disabled"}}  id="multiple_{{ $i }}"> Multiple <small>(files & select)</small>    </label>    
                                            </div>
                                            <div class="col">
                                                <div class="form-group d-flex justify-content-around">
                                                    <textarea name="fields[default][{{ $i }}]" rows="1"  class="form-control  @if(old('fields') && old('fields')['table'][$i] != "") d-none @endif">{{ (old('fields') && old('fields')['default'][$i] ? old('fields')['default'][$i] : '') }}</textarea>
                                                    <select name="fields[table][{{ $i }}]" class="form-control table @if(old('fields') && old('fields')['table'][$i] != "")  @else d-none @endif">
                                                ...
                                                <label title="Your form contains this field in a quarter of a row.">
                                                    <input type="checkbox" class="ml-2 export" {{ (old('fields') && @old('fields')['options']['export_'.$i] == 'export' ) ? 'checked' : ""}} name="fields[options][export_{{ $i }}]" value="export" id="export_{{ $i }}"> export
                                                </label>
                                                <label title="Your form contains this field in a quarter of a row.">
                                                    <input type="checkbox" class="ml-2 import" {{ (old('fields') && @old('fields')['options']['import_'.$i] == 'import' ) ? 'checked' : ""}} name="fields[options][import_{{ $i }}]" value="import" id="import_{{ $i }}"> import
                                                </label>
                                                <label title="Your form contains this field in a quarter of a row.">
                                                <input type="checkbox" class="ml-2 column" name="fields[column][column_{{ $i }}]" value="col-md-3" {{ (old('fields') && @old('fields')['column']['column_'.$i] == 'col-md-3' ) ? 'checked' : ""}} id="column_{{ $i }}"> md-3</label>
                                              
                                             </div>
                                            <div class="col ">
                                                <div class="form-group ml-1">
                                                    <input type="text" class="form-control" value="{{ (old('fields') && old('fields')['comment'][$i] ) ? old('fields')['comment'][$i] : ""}}" name="fields[comment][{{ $i }}]" placeholder="Comment" />
                                                </div>
                                                <label title="Your form contains this field in a one-third of a row.">
                                                    <input type="checkbox" class="ml-2 column" name="fields[column][column_{{ $i }}]" value="col-md-4" {{ (old('fields') && @old('fields')['column']['column_'.$i] == 'col-md-4' ) ? 'checked' : ""}} id="column_{{ $i }}"> md-4    </label>    
                                                <label title="Your form contains this field in a half of a row.">
                                                <input type="checkbox" class="ml-2 column" name="fields[column][column_{{ $i }}]" {{ (old('fields') && @old('fields')['column']['column_'.$i] == 'col-md-6' ) ? 'checked' : ""}} value="col-md-6" id="column_{{ $i }}"> md-6 </label>
                                                <label title="Your form contains this field in a full row.">
                                                <input type="checkbox" class="ml-2 column" name="fields[column][column_{{ $i }}]" {{ (old('fields') && @old('fields')['column']['column_'.$i] == 'col-md-12' ) ? 'checked' : ""}} value="col-md-12" id="column_{{ $i }}"> md-12 </label>       
                                            </div>
                                            <div class="col-12 justify-content-around  {{ (old('fields') && @old('fields')['options']['cascade_'.$i] ) ? 'd-md-flex' : "d-none"}} " id="cascadediv{{ $i }}">
                                                <div class="mt-4">Enter Ref Table Name (PhpMyAdmin)</div>
                                                <div class="form-group">
                                                    <input type="text" name="fields[ref_table][{{ $i }}]" class="form-control d-inline-flex" placeholder="Enter table name" value="{{ old('fields') && @old('fields')['ref_table'][$i]}}">
                                                </div>
                                                <div class="mt-4">Enter Ref Column Name</div>
                                                <div class="form-group">
                                                    <input type="text" name="fields[ref_col][{{ $i }}]" class="form-control d-inline-flex" placeholder="Enter column name" value="{{ old('fields') && @old('fields')['ref_col'][ $i]}}">
                                                </div>
                                                <div class="form-group">
                                                    <label title="On Delete.">
                                                    <input type="checkbox" class="ml-2 " {{ (old('fields') && @old('fields')['ref_on_delete_'.$i] == 'OnDelete' ) ? 'checked' : ""}} name="fields[ref_on_delete_{{ $i }}]" value="OnDelete" id="ref_on_delete_{{ $i }}" checked> OnDelete<label>
                                                </div>
                                                <div class="form-group">
                                                    <label title="On update">
                                                        <input type="checkbox" class="ml-2 " {{ (old('fields') && @old('fields')['ref_on_update_'.$i] == 'OnUpdate' ) ? 'checked' : ""}} name="fields[ref_on_update_{{ $i }}]" value="OnUpdate" id="ref_on_update_{{ $i }}" checked> OnUpdate<label>
                                                </div>
                                            </div>
                                        </li>
                                    @endfor
                ...
                <div class="col-md-4">
                    ...
                    <div class="card text-white bg-primary mb-3">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div>
                                <button class="btn btn-accent btn-sm btn-add" id="magicValidation" type="button">#</button>
                        ...
                        <div class="card-body validations">
                            ...
                            <div class="row no-gutters align-items-center validation">
                                ...
                                <div class="col">
                                    <div class="form-group mr-1">
                                        <input type="text" class="form-control" value="{{ (old('validations') && old('validations')['rules'][0]) ? old('validations')['rules'][0]: 'nullable' }}" name="validations[rules][]" id="rule0" placeholder="Rules"/>
                                    </div>
                                </div>
                            </div>
                            @if(old('validations') && count(old('validations')['field']) > 0)
                                @for($vi = 1; $vi<count(old('validations')['field']); $vi++)
                                    <div class="row no-gutters align-items-center validation">
                                        ...
                                        <div class="col">
                                            <div class="form-group mr-1">
                                                <input type="text" class="form-control" value="{{ (old('validations') && old('validations')['rules'][$vi]) ? old('validations')['rules'][$vi]:'' }}" name="validations[rules][]" id="rule{{ $vi }}" value="nullable" placeholder="Rules"/>
                                            </div>
                                        </div>
                                    </div>
                                @endfor
                        ...
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col text-center">
                                    ...
                                    <label for="export_btn"><input type="checkbox" id="export_btn" name="export_btn" value="1" @if(old('export_btn') == 1)  @endif />Export</label><br>
                                </div>
                                <div class="col text-center">
                                    ...
                                    <label for="import_btn"><input type="checkbox" id="import_btn" name="import_btn" value="1" @if(old('import_btn') == 1)  @endif />Import</label><br>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="card text-white bg-primary mb-3">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div>
                                <button class="btn btn-accent btn-sm btn-add" type="button" title="Add New Field" id="addMediaInputBtn">+</button>
                                    <button class="btn btn-accent btn-sm btn-sub" type="button" title="Last Field Delete" id="removeMediaInputBtn">-</button>
                            </div>
                        </div>
                        <div class="card-body">
                            <ul id="mediaSortable" class="mediaInputs p-0">
                                {{-- <li class="row no-gutters ui-state-default align-items-center field">
                                    ...
                                    <div class="col">
                                        <div class="form-group mr-1">
                                            <input required type="text" class="form-control media_col_name" value="{{ (old('media') && old('media')['name'][0] ) ? old('media')['name'][0] : ""}}" data-id="0" id="media_name0" name="media[name][0]" placeholder="Name" />
                                        </div>
                                        <label title="To ensure the field is required from both the client and server sides, this is helpful.">
                                            <input type="checkbox" class="ml-2 do-media-required"  {{ (old('media') && @old('media')['options']['required_0'] ) ? 'checked' : ""}} name="media[options][required_0]" value="required" id="media-required_0"> Required
                                        </label>
                                    </div>
                                    <div class="col">
                                        <div class="form-group mr-1">
                                            <input type="number" class="form-control" value="{{ (old('media') && old('media')['size'][0] ) ? old('media')['name'][0] : ""}}" data-id="0" min="1" id="media_size0" name="media[size][0]" placeholder="Size (in MB)" />
                                        </div>
                                        <label title="To ensure that null values are accepted.">
                                            <input type="checkbox" class="ml-2 do-media-nullable" {{ (old('media') && @old('media')['options']['required_0'] ) ? '' : "checked"}} name="media[options][nullable_0]" value="nullable" id="media-nullable_0"> Null
                                        </label>
                                    </div>
                                    <div class="col">
                                        <div class="form-group mr-1">
                                            <input type="number" class="form-control" value="{{ (old('media') && old('media')['col'][0] ) ? old('media')['name'][0] : ""}}" data-id="0" min="1" max="12" id="media_col0" name="media[col][0]" placeholder="Enter col-md" />
                                        </div>
                                        <label title="To ensure that null values are multiple.">
                                            <input type="checkbox" class="ml-2" {{ (old('media') && @old('media')['options']['media-multiple_0'] ) ? 'checked' : ""}} name="media[options][multiple_0]" value="multiple" id="media-multiple_0"> Multiple
                                        </label>
                                    </div>
                                </li> --}}
                                ...
                                @for($i = 1; $i<count(old('media')['name']); $i++)
                                    <li class="row no-gutters ui-state-default align-items-center field">
                                        ...
                                        <div class="col">
                                            <div class="form-group mr-1">
                                                <input required type="text" class="form-control media_col_name" value="{{ (old('media') && old('media')['name'][ $i] ) ? old('media')['name'][$i] : ""}}" data-id="{{ $i }}" id="media_name{{ $i }}" name="media[name][{{ $i }}]" placeholder="Name" />
                                            </div>
                                            <label title="To ensure the field is required from both the client and server sides, this is helpful.">
                                                <input type="checkbox" class="ml-2 do-media-required"  {{ (old('media') && @old('media')['options']['required_'.$i] ) ? 'checked' : ""}} name="media[options][required_{{ $i }}]" value="required" id="media-required_{{ $i }}"> Required
                                            </label>
                                          
                                        </div>
                                        <div class="col">
                                            <div class="form-group mr-1">
                                                <input type="number" class="form-control" value="{{ (old('media') && old('media')['size'][ $i] ) ? old('media')['size'][$i ] : ""}}" min="1" data-id="{{ $i }}" id="media_name{{ $i }}" name="media[size][{{ $i }}]" placeholder="Size (in MB)" />
                                            </div>
                                            <label title="To ensure that null values are accepted.">
                                                <input type="checkbox" class="ml-2 do-media-nullable" {{ (old('media') && @old('media')['options']['required_'.$i] ) ? '' : "checked"}} name="media[options][nullable_{{ $i }}]" value="nullable" id="media-nullable_{{ $i }}"> Null
                                            </label>
                                        </div>
                                        <div class="col">
                                            <div class="form-group mr-1">
                                                <input type="number" class="form-control" value="{{ (old('media') && old('media')['col'][$i] ) ? old('media')['name'][$i] : ""}}" data-id="{{ $i }}" id="media_col{{ $i }}" name="media[col][{{ $i }}]" placeholder="Enter col-md" min="1" max="12" />
                                            </div>
                                            <label title="To ensure that null values are multiple.">
                                                <input type="checkbox" class="ml-2" {{ (old('media') && @old('media')['options']['multiple_'.$i] ) ? 'checked' : ""}} name="media[options][multiple_{{ $i }}']" value="multiple" id="media-multiple_{{ $i }}"> multiple
                                            </label>
                                        </div>
                                    </li>
                                @endfor
    ...
    <script>
        ...
        function autoSelect(text,$this){
            ...
            if(text.includes('_id')){
                $this.closest('.field').find('[name="fields[type]['+col_id+']"] [value="bigInteger"]').attr('selected', 'selected');
                $this.closest('.field').find('[name="fields[input]['+col_id+']"] [value="select_via_table"]').attr('selected', 'selected');
                var val = text.replace('_id',''); var val = val.replace('_','');
                var value = @json($tmpFiles).filter(function(obj) {
                    if(obj.filename.toLowerCase() === val) return obj;
                }).map(function(obj) { return obj.filename; });
                   if(value.length > 0)
                   $this.closest('.field').find('[name="fields[table]['+col_id+']"] [value="'+value[0]+'"]').attr('selected', 'selected');
                ...
                $this.closest('.field').find('[name="fields[type]['+col_id+']"] [value="enum"]').attr('selected', 'selected');
                $this.closest('.field').find('[name="fields[input]['+col_id+']"] [value="select"]').attr('selected', 'selected');
                if(text.includes('role')){
                    $this.closest('.field').find('[name="fields[comment]['+col_id+']"]').prop('required',true).val('"Normal User","Special User"');
                    $this.closest('.field').find('[name="fields[default]['+col_id+']"]').val('Normal User');
                }else{
                    $this.closest('.field').find('[name="fields[comment]['+col_id+']"]').prop('required',true).val('"Active","Inactive"');
                    $this.closest('.field').find('[name="fields[default]['+col_id+']"]').val('Active');
                }
            }else if(text.includes('is_') || text.includes('_is')){
                $this.closest('.field').find('[name="fields[type]['+col_id+']"] [value="boolean"]').attr('selected', 'selected');
                $this.closest('.field').find('[name="fields[input]['+col_id+']"] [value="radio"]').attr('selected', 'selected');
            }else if(text.includes('date_time')){
               $this.closest('.field').find('[name="fields[type]['+col_id+']"] [value="dateTime"]').attr('selected', 'selected');
               $this.closest('.field').find('[name="fields[input]['+col_id+']"] [value="datetime-local"]').attr('selected', 'selected');
            }else if(text.includes('date')){
                $this.closest('.field').find('[name="fields[type]['+col_id+']"] [value="date"]').attr('selected', 'selected');
                $this.closest('.field').find('[name="fields[input]['+col_id+']"] [value="date"]').attr('selected', 'selected');
                $('#rule'+col_id).val($('#rule'+col_id).val()+'|date');
            }else if(text.includes('email')){
                $this.closest('.field').find('[name="fields[type]['+col_id+']"] [value="string"]').attr('selected', 'selected');
                $this.closest('.field').find('[name="fields[input]['+col_id+']"] [value="email"]').attr('selected', 'selected');
            }else if(text.includes('phone') || text.includes('pincode') || text.includes('zipcode') || text.includes('batch')){
                $this.closest('.field').find('[name="fields[type]['+col_id+']"] [value="string"]').attr('selected', 'selected');
                $this.closest('.field').find('[name="fields[input]['+col_id+']"] [value="number"]').attr('selected', 'selected');
            }else if(text.includes('name') || text.includes('title') || text.includes('model_type') || text.includes('slug')){
                $this.closest('.field').find('[name="fields[type]['+col_id+']"] [value="string"]').attr('selected', 'selected');
                $this.closest('.field').find('[name="fields[input]['+col_id+']"] [value="text"]').attr('selected', 'selected');
            }else if(text.includes('file') || text.includes('image') || text.includes('attachment')){
                $this.closest('.field').find('[name="fields[type]['+col_id+']"] [value="text"]').attr('selected', 'selected');
                $this.closest('.field').find('[name="fields[input]['+col_id+']"] [value="file"]').attr('selected', 'selected');
                $this.closest('.field').find('#multiple_'+col_id).removeAttr('disabled');
            }else if(text.includes('description') || text.includes('_text')){
                $this.closest('.field').find('[name="fields[type]['+col_id+']"] [value="longText"]').attr('selected', 'selected');
                $this.closest('.field').find('[name="fields[input]['+col_id+']"] [value="textarea"]').attr('selected', 'selected');

            }else if(text.includes('url') || text.includes('website')){
                $this.closest('.field').find('[name="fields[type]['+col_id+']"] [value="string"]').attr('selected', 'selected');
                $this.closest('.field').find('[name="fields[input]['+col_id+']"] [value="url"]').attr('selected', 'selected');

            }else if(text.includes('amount') || text.includes('price') || text.includes('rate') || text.includes('_rate')){
                $this.closest('.field').find('[name="fields[type]['+col_id+']"] [value="double"]').attr('selected', 'selected');
                $this.closest('.field').find('[name="fields[input]['+col_id+']"] [value="decimal"]').attr('selected', 'selected');
                
            }else if(text.includes('tax')){
                $this.closest('.field').find('[name="fields[type]['+col_id+']"] [value="tinyInteger"]').attr('selected', 'selected');
                $this.closest('.field').find('[name="fields[input]['+col_id+']"] [value="number"]').attr('selected', 'selected');
                
            }else if(text.includes('remark') || text.includes('address')){
                $this.closest('.field').find('[name="fields[type]['+col_id+']"] [value="text"]').attr('selected', 'selected');
                $this.closest('.field').find('[name="fields[input]['+col_id+']"] [value="textarea"]').attr('selected', 'selected');
                
            }else if(text.includes('payload') || text.includes('fields') || text.includes('ekyc')){
                $this.closest('.field').find('[name="fields[type]['+col_id+']"] [value="json"]').attr('selected', 'selected'); 
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#addValidations', function () {
                ...
                var tmp =   '<div class="row no-gutters align-items-center validation">\n' +
                            ...
                            '    <div class="col">\n' +
                            '        <div class="form-group mr-1">\n' +
                            '            <input type="text" class="form-control" id="rule'+iteration+'" name="validations[rules][]" value="nullable" placeholder="Rules"/>\n' +
                            '        </div>\n' +
                            '    </div>\n' +
                            '</div>';
            ...
            $(document).on('click', '#addFieldsBtn', function () {
                // inputval = 0;
                var html ;
                    html ='  <textarea name="fields[default]['+iteration+']" rows="1" class="form-control"></textarea>\n';
              
                    html += '   <select name="fields[table]['+iteration+']" class="form-control  table d-none" id="">\n'+
                ...
                var tmp =   '<li class="row no-gutters ui-state-default align-items-center field">\n' +
                    ' <span class="btn-accent btn-sm mr-3 hash">#</span>'+
                            '    <div class="col">\n' +
                            '        <div class="form-group mr-1">\n' +
                            '            <input required type="text" class="form-control col_name" data-id="'+iteration+'" id="col_name'+iteration+'" name="fields[name]['+iteration+']" placeholder="Name" />\n' +
                            '        </div>\n' +
                            '         <label title="To ensure the field is required from both the client and server sides, this is helpful."><input type="checkbox" class="ml-2 do-required" name="fields[options][required_'+iteration+']" value="required"  id="required_'+iteration+'"> Required</label>'+
                            '      <label title="To ensure that null values are accepted.">  <input type="checkbox" class="ml-2 do-nullable" name="fields[options][nullable_'+iteration+']" value="nullable" checked id="nullable_'+iteration+'"> Null</label>'+
                            '      <label title="To ensure ascending descending sorting can be performed.">  <input type="checkbox" class="ml-2 do-sorting" name="fields[options][sorting_'+iteration+']" value="sorting" id="sorting_'+iteration+'"> Sort<label>'+
                            '    </div>\n' +
                            '    <div class="col">\n' +
                            '        <div class="form-group mr-1">\n' +
                            '            <select name="fields[type]['+iteration+']" class="form-control select2">\n' +
                            '                <option value="">--Select Field Type--</option>\n' +
                            ...
                            '            </select>\n' +
                            '        </div>\n' +
                            '       <label title="To ensure that the field is displayed in the table."> <input type="checkbox" class="ml-2" name="fields[options][showindex_'+iteration+']" value="showindex" id="showindex_'+iteration+'">Index</label>'+
                            '       <label title="To ensure that the field is searchable in the table.">  <input type="checkbox" class="ml-2"  name="fields[options][cansearch_'+iteration+']" value="cansearch" id="cansearch_'+iteration+'">Search</label>'+
                            '       <label title="To ensure that the record is delete in that table if the reference table record delete.">  <input type="checkbox" class="ml-2"  name="fields[options][cascade_'+iteration+']" value="cascade" id="cascade_'+iteration+'" disabled>Cascade</label>'+
                            '    </div>\n' +
                            '    <div class="col">\n' + 
                            '        <div class="form-group mr-1">\n' +
                            '               <select name="fields[input]['+iteration+']" class="form-control select2 fields-type">\n' +
                                            '<option value="">--Select Input Type--</option>>\n' +
                                       ...
                                       ' </select>\n' +
                            '        </div>\n' +
                            '    <label title="To ensure that the field accepts unique values from the database.">  <input type="checkbox" class="ml-2 do-unique"  name="fields[options][unique_'+iteration+']" value="unique" id="unique_'+iteration+'"> Unique</label>'+
                            ' <label title="To ensure that multiple values can be entered into the field.">   <input type="checkbox" class="ml-2" name="fields[options][multiple_'+iteration+']" value="multiple" disabled id="multiple_'+iteration+'"> Multiple <small>(files & select)</small></label>'+
                            '    </div>\n' +
                                '<div class="col">\n' +
                                    '<div class="form-group d-flex justify-content-around">\n '+
                                        html
                                    +' </div>\n'+
                                    '<label title="Your form contains this field in a quarter of a row."><input type="checkbox" class="ml-2 export" name="fields[options][export_'+iteration+']" value="export" id="export_'+iteration+'"> export</label>'+
                                    '<label title="Your form contains this field in a quarter of a row."><input type="checkbox" class="ml-2 import" name="fields[options][import_'+iteration+']" value="import" id="import_'+iteration+'"> import</label>'+
                                    '<label title="Your form contains this field in a quarter of a row."><input type="checkbox" class="ml-2 column" name="fields[column][column_'+iteration+']" value="col-md-3" id="column_'+iteration+'"> md-3</label>'+
                                  
                               ' </div>\n'+
                                '<div class="col">\n' +
                                    '<div class="form-group ml-1">\n '+
                            '            <input type="text" class="form-control" name="fields[comment]['+iteration+']" placeholder="Comment"/>\n' +
                                    ' </div>\n'+
                                    '<label title="Your form contains this field in a one-third of a row."><input type="checkbox" class="ml-2 column" name="fields[column][column_'+iteration+']" value="col-md-4" id="column_'+iteration+'"> md-4</label>'+
                                    '<label title="Your form contains this field in a half of a row."><input type="checkbox" class="ml-2 column" name="fields[column][column_'+iteration+']" checked value="col-md-6" id="column_'+iteration+'"> md-6 </label>'+
                                    '<label title="Your form contains this field in a full row."><input type="checkbox" class="ml-2 column" name="fields[column][column_'+iteration+']" value="col-md-12" id="column_'+iteration+'"> md-12 </label>'+
                               ' </div>\n'+
                              ' <div class="col-12 justify-content-around d-none" id="cascadediv'+iteration+'">'+
                                    '<div class="mt-4">Enter Ref Table Name (PhpMyAdmin)</div>'+
                                    '<div class="form-group">'+
                                        '<input type="text" name="fields[ref_table]['+iteration+']" class="form-control d-inline-flex" value="" placeholder="Enter table name" value="{{ old('fields') && @old('fields')['ref_table']['+iteration+']}}">'+
                                   ' </div>'+
                                    '<div class="mt-4">Enter Ref Column Name</div>'+
                                    '<div class="form-group">'+
                                        '<input type="text" name="fields[ref_col]['+iteration+']" class="form-control d-inline-flex" value="id" placeholder="Enter column name" value="{{ old('fields') && @old('fields')['ref_col'][ '+iteration+']}}">'+
                                    '</div>'+
                                    '<div class="form-group">'+
                                        '<label title="On Delete.">'+
                                        '<input type="checkbox" class="ml-2 " name="fields[ref_on_delete_'+iteration+']" value="OnDelete" id="ref_on_delete_'+iteration+'" checked> OnDelete<label>'+
                                   ' </div>'+
                                    '<div class="form-group">'+
                                        '<label title="On update">'+
                                            '<input type="checkbox" class="ml-2 " name="fields[ref_on_update_'+iteration+']" value="OnUpdate" id="ref_on_update_'+iteration+'" checked> OnUpdate<label>'+
                                   ' </div>'+
                               ' </div>'+
                            '</li>';
                $('.fields').append(tmp);
            ...
            $(document).on('click', '#addMediaInputBtn', function () {
                var tmp =   '<li class="row no-gutters ui-state-default align-items-center field">\n' +
                    ' <span class="btn-accent btn-sm mr-3 hash">#</span>'+
                            '    <div class="col">\n' +
                            '        <div class="form-group mr-1">\n' +
                                        '            <input required type="text" class="form-control media_col_name" data-id="'+mediaIteration+'" id="col_name'+mediaIteration+'" name="media[name]['+mediaIteration+']" placeholder="Name" />\n' +
                                    ' </div>\n' +
                                    '  <label title="To ensure the field is required from both the client and server sides, this is helpful."><input type="checkbox" class="ml-2 do-media-required" name="media[options][required_'+mediaIteration+']" value="required"  id="media-required_'+mediaIteration+'"> Required</label>'+
                                ' </div>'+
                                '<div class="col">'+
                                    '<div class="form-group mr-1">'+
                                        '<input type="number" class="form-control" min="1" data-id="'+mediaIteration+'" id="media_size'+mediaIteration+'" name="media[size]['+mediaIteration+']" placeholder="Size (in MB)" />'+
                                    ' </div>'+
                            '      <label title="To ensure that null values are accepted.">  <input type="checkbox" class="ml-2 do-nullable" name="media[options][nullable_'+mediaIteration+']" value="nullable" checked id="media-nullable_'+mediaIteration+'"> Null</label>'+
                            ' </div>'+
                                '<div class="col">'+
                                    '<div class="form-group mr-1">'+
                                        '<input type="number" class="form-control" min="1" max="12" data-id="'+mediaIteration+'" id="media_col'+mediaIteration+'" name="media[col]['+mediaIteration+']" placeholder="Enter col-md" />'+
                                    ' </div>'+
                            '      <label title="To ensure ascending descending sorting can be performed.">  <input type="checkbox" class="ml-2 do-sorting" name="media[options][multiple_'+mediaIteration+']" value="multiple" id="media-multiple_'+mediaIteration+'"> Multiple<label>'+
                            '    </div>\n' +
                            '</li>';
                $('.mediaInputs').append(tmp);
                mediaIteration = mediaIteration+1;
            });
            ...
            $(document).on('change', '.fields-type', function () {
                var col_id = $(this).parent().parent().siblings().children().find('.col_name').data('id');
                var col_value = $(this).parent().parent().siblings().children().find('.col_name').val();
                ...
                if($(this).val() == "hidden" && $('[name="fields[type]['+col_id+']"]').val() != 'json')  {
                    target.val(col_value);
                } else if($(this).val() == "date" || $(this).val() == "datetime-local")  {
                    target.val('now()');
                } else if($(this).val() == "checkbox" || $(this).val() == "radio")  {
                    target.val('1');
                } else if($(this).val() == "select" || $(this).val() == "select_via_table" || $(this).val() == "file")  {
            ...
            $(document).on('focusout', '.model_name', function (e) {
                ...
                var str = s.toLowerCase().substring(1);
            ...
            $(document).on('click', '.do-unique', function(e) {
                ...
                if( $('[name="fields[default]['+opt_id+']"]').val() != '' || $('[name="fields[type]['+opt_id+']"]').val() == 'enum'|| $('[name="fields[type]['+opt_id+']"]').val() == 'boolean'){
                    $(this).prop('checked',false);
                    alert('unique is only possible when data type is not boolean/enum and no default value provided!');
                }
                
                $('#rule'+opt_id).val($('#rule'+opt_id).val()+'|unique:'+$('.crud_name').val()+','+$('#col_name'+opt_id).val());
            });
        ...
        $('.magicValidation').click(function(){
            $(document).on('each', '.validation', function (e){
               var text = $(this).find('validations[field][]').val();
               var rules = $(this).find('validations[rules][]').val();
               if(rules!=''){
                rules = rules+'|';
               }
            });
