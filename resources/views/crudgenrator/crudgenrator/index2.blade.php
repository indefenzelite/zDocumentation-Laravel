                          ...
                          <div class="row">
                              ...
                              {{-- <div class="col-12 col-md">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('search') }}" class="form-control lower" name="search" id="search" placeholder="Enter Searchable Fields" requireds>
                            ...
                            <div class="row no-gutters align-items-center field">
                                <div class="col">
                                    <div class="form-group mr-1">
                                        <input requireds type="text" class="form-control col_name" value="{{ (old('fields') && old('fields')['name'][0] ) ? old('fields')['name'][0] : ""}}" data-id="0" id="col_name0" name="fields[name][]" placeholder="Name" />
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group mr-1">
                                        <select requireds name="fields[type][]" class="form-control select2">
                                ...
                                <div class="col">
                                    <div class="form-group mr-1">
                                        <select requireds name="fields[input][]" class="form-control select2 fields-type">
                                ...
                                <div class="col">
                                    <div class="form-group d-flex justify-content-around">
                                        {{-- <select name="fields[default][]" data-id="0" id="fields0" class="form-control Options">
                                            <option @if(old('fields') && old('fields')['default'][0] == "1") selected @endif value="1">requireds</option>
                                        ...
                                        <select name="fields[other][]" data-id="0" class="form-control Other d-none">
                                                  
                                        </select>
                                        <input type="text" name="fields[default][]" data-id="0" class="form-control Default d-none" placeholder="Default Value">
                                        <div class="dropdown Options" data-id="0" id="fields0">
                                            <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                              Options
                                            </button>
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                              <a class="dropdown-item" href="#"><input type="checkbox" name="fields[options][required_0]" value="required" id="required_0"> Required</a>
                                              <a class="dropdown-item" href="#"><input type="checkbox" name="fields[options][nullable_0]" value="nullable" id="nullable_0"> Null</a>
                                              <a class="dropdown-item" href="#"><input type="checkbox" name="fields[options][showindex_0]" value="showindex" id="showindex_0"> In Index</a>
                                              <a class="dropdown-item" href="#"><input type="checkbox" name="fields[options][cansearch_0]" value="cansearch" id="cansearch_0"> Can Search</a>
                                              <a class="dropdown-item" href="#"><input type="checkbox" name="fields[options][unique_0]" value="unique" id="unique_0"> Unique</a>
                                            </div>
                                        </div>
                                        <textarea name="fields[select][]" rows="1" style="resize: none; opacity: 0" class="form-control d-none" placeholder="1:Active,2:Inactive"></textarea>
                                ...
                                <div class="col">
                                    <div class="form-group ml-1">
                                        <input requireds type="text" class="form-control d-inline-flex" value="{{ (old('fields') && old('fields')['comment'][0] ) ? old('fields')['comment'][0] : ""}}" name="fields[comment][]" placeholder="Comment" />
                                    </div>
                                </div>
                            </div>
                            @if(old('fields') && count(old('fields')['name']) > 0)
                                @for($i = 1; $i<count(old('fields')['name']); $i++)
                                    <div class="row no-gutters align-items-center field">
                                        <div class="col">
                                            <div class="form-group mr-1">
                                                <input requireds type="text" class="form-control col_name" value="{{ (old('fields') && old('fields')['name'][$i] ) ? old('fields')['name'][$i] : ""}}" data-id="{{ $i }}" id="col_name{{ $i }}" name="fields[name][]" placeholder="Name" />
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group mr-1">
                                        ...
                                        <div class="col">
                                            <div class="form-group d-flex justify-content-around">
                                                {{-- <select name="fields[default][]" data-id="{{ $i }}" id="fields{{ $i }}" class="form-control Options">
                                                    <option @if(old('fields') && old('fields')['default'][$i] == "1") selected @endif value="1">requireds</option>
                                                ...
                                                <select name="fields[other][]" data-id="{{ $i }}" class="form-control Other d-none">
                                                  
                                                </select>
                                                <input type="text" name="fields[default][]" data-id="{{ $i }}" class="form-control Default d-none" placeholder="Default Value">
                                                <div class="dropdown Options" data-id="{{ $i }}" id="fields{{ $i }}" >
                                                    <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                      Options
                                                    </button>
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                      <a class="dropdown-item" href="#"><input type="checkbox" name="fields[options][required_{{ $i }}]" value="required" id="required_0"> Required</a>
                                                      <a class="dropdown-item" href="#"><input type="checkbox" name="fields[options][nullable_{{ $i }}]" value="nullable" id="nullable_0"> Null</a>
                                                      <a class="dropdown-item" href="#"><input type="checkbox" name="fields[options][showindex_{{ $i }}]" value="showindex" id="showindex_0"> In Index</a>
                                                      <a class="dropdown-item" href="#"><input type="checkbox" name="fields[options][cansearch_{{ $i }}]" value="cansearch" id="cansearch_0"> Can Search</a>
                                                      <a class="dropdown-item" href="#"><input type="checkbox" name="fields[options][unique_{{ $i }}]" value="unique" id="unique_0"> Unique</a>
                                                    </div>
                                                </div>
                                                <textarea name="fields[select][]" rows="1" style="resize: none; opacity: 0" class="form-control d-none"  placeholder="1:Active,2:Inactive"></textarea>
                                                <select name="fields[table][]" class="form-control table d-none">
                                        ...
                                        <div class="col ">
                                            <div class="form-group ml-1">
                                                <input requireds type="text" class="form-control" value="{{ (old('fields') && old('fields')['comment'][$i] ) ? old('fields')['comment'][$i] : ""}}" name="fields[comment][]" placeholder="Comment" />
                                            </div>
                                        </div>
                    ...
                    <div class="card text-white bg-primary mb-3">
                        ...
                        <div class="card-body validations">
                            ...
                            <div class="row no-gutters align-items-center validation">
                                ...
                                <div class="col">
                                    <div class="form-group mr-1">
                                        <input type="text" class="form-control" value="{{ (old('validations') && old('validations')['rules'][0]) ? old('validations')['rules'][0]: 'requireds' }}" name="validations[rules][]" id="rule0" placeholder="Rules"/>
                                    </div>
                                </div>
                            </div>
                            @if(old('validations') && count(old('validations')['field']) > 0)
                                @for($vi = 1; $vi<count(old('validations')['field']); $vi++)
                                    <div class="row no-gutters align-items-center validation">
                                        ...
                                        <div class="col">
                                            <div class="form-group mr-1">
                                                <input type="text" class="form-control" value="{{ (old('validations') && old('validations')['rules'][$vi]) ? old('validations')['rules'][$vi]:'' }}" name="validations[rules][]" id="rule{{ $vi }}" value="requireds" placeholder="Rules"/>
                                            </div>
                                        </div>
                                    </div>
                                @endfor
                    ...
                    <div class="accordion-body">
                        <ul>
                            ...
                            <div class="col-md-3">
                                ...
                                <li>regex:[0-9]</li>
                                <li>requireds</li>
                                <li>requireds_if:field,value</li>
                            </div>
                            <div class="col-md-3">
                                <li>requireds_with:foo,bar,...</li>
                                <li>requireds_with_all:foo,bar,...</li>
                                <li>requireds_without:foo,bar,...</li>
                                <li>requireds_without_all:foo,bar,...</li>
                                <li>same:field</li>
                                <li>size:value</li>
                                <li>timezone</li>
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#addValidations', function () {
                ...
                var tmp =   '<div class="row no-gutters align-items-center validation">\n' +
                            ...
                            '    <div class="col">\n' +
                            '        <div class="form-group mr-1">\n' +
                            '            <input type="text" class="form-control" id="rule'+iteration+'" name="validations[rules][]" value="requireds" placeholder="Rules"/>\n' +
                            '        </div>\n' +
                            '    </div>\n' +
                            '</div>';
            ...
            $(document).on('click', '#addFieldsBtn', function () {
                // inputval = 0;
                var html ;
                     html =   '<div class="dropdown Options" data-id="'+iteration+'" id="fields'+iteration+'">\n'+
                        '    <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">\n'+
                        '        Options\n'+
                        '    </button>\n'+
                        '    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">\n'+
                        '        <a class="dropdown-item" href="#"><input type="checkbox" name="fields[options][required_'+iteration+']" value="required" id="required_0"> Required</a>\n'+
                        '        <a class="dropdown-item" href="#"><input type="checkbox" name="fields[options][nullable_'+iteration+']" value="nullable" id="nullable_0"> Null</a>\n'+
                        '        <a class="dropdown-item" href="#"><input type="checkbox" name="fields[options][showindex_'+iteration+']" value="showindex" id="showindex_0"> In Index</a>\n'+
                        '        <a class="dropdown-item" href="#"><input type="checkbox" name="fields[options][cansearch_'+iteration+']" value="cansearch" id="cansearch_0"> Can Search</a>\n'+
                        '        <a class="dropdown-item" href="#"><input type="checkbox" name="fields[options][unique_'+iteration+']" value="unique" id="unique_0"> Unique</a>\n'+
                        '    </div>\n'+
                        '</div>\n'+
                        ' <select name="fields[other][]" data-id="'+iteration+'" class="form-control Other d-none">\n'+
                        '</select>\n'+
                        '<input type="text" name="fields[default][]" data-id="'+iteration+'" class="form-control Default d-none" \n'+'placeholder="Default Value">\n';
                    // html =' <select name="fields[default][]" data-id="'+iteration+'" id="fields'+iteration+'" class="form-control Options" id="">\n'+
                    // '    <option value="1">requireds</option>\n'+
                ...
                var tmp =   '<div class="row no-gutters align-items-center field">\n' +
                            '    <div class="col">\n' +
                            '        <div class="form-group mr-1">\n' +
                            '            <input requireds type="text" class="form-control col_name" data-id="'+iteration+'" id="col_name'+iteration+'" name="fields[name][]" placeholder="Name" />\n' +
                            '        </div>\n' +
                            '    </div>\n' +
                            '    <div class="col">\n' +
                            '        <div class="form-group mr-1">\n' +
                            ...
                            '    </div>\n' +
                               ...
                               ' </div>\n'+
                                '<div class="col">\n' +
                                    '<div class="form-group ml-1">\n '+
                            '            <input requireds type="text" class="form-control" name="fields[comment][]" placeholder="Comment"/>\n' +
                                    ' </div>\n'+
                               ' </div>\n'+
                            '</div>';
                $('.fields').append(tmp);
            ...
            $(document).on('input', '#view_path', function () {
                if ($(this).val().length <= 0 ){
                    ...
                    $('#controller_path_preview').val('Panel');
                } else{
                    $('#view_path_preview').html($(this).val() + '/');
                    $('#controller_path_preview').val(capitalizeFirstLetter($(this).val()));
                }
            })
            ...
            $(document).on('change', '.fields-type', function () {
                ...
                var target3 = $(this).parent().parent().siblings().children().find('.Other');
                var target4 = $(this).parent().parent().siblings().children().find('.Default');
                // alert($(this).val());
                console.log(target);
                console.log(target1);
                console.log(target2);
                target3.addClass('d-none');
                target4.removeClass('d-none');
                target3.parent().parent().removeClass('col-4');
                if ($(this).val() === 'select'){
                    inputval = 1;
                    ...
                    target3.parent().parent().addClass('col-4');
                    target4.addClass('d-none');
                ...
                if($(this).val() === 'file'|| $(this).val() === 'textarea'){
                    other_html = '';
                    if($(this).val() === 'file'){
                        other_html = '<option value="single">single</option><option value="multiple">multiple</option>';
                    }else if($(this).val() === 'textarea'){
                        other_html = '<option value="normal">normal</option><option value="Richtext">Richtext</option>';
                        
                    }
                    target3.html(other_html);
                    target3.removeClass('d-none');
                    target4.addClass('d-none');
                }
                selectRefresh();
            })
