            ...
            <div class="col-lg-7 col-md-12 col-12 justify-content-center mx-auto mt-4">
                <div class="card html-content">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <h5 class="fw-600  mb-0">Tax Invoice</h5>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-12 table-responsive">
                                ...
                                <hr class="mt-0">
                                <div class="text-right mr-4" style="font-size: 14px;">{{ __('Grand Total : ')}}<b> {{format_price($total)}} </b></div>
                            </div>
                        </div>
                        <div class="row no-print mt-3">
                            <div class="col-12">
                                <a href="javascript:void(0)" onclick="CreatePDFfromHTML()" title="Download PDF" class="print-btn btn btn-sm btn-primary">Download</a>
                                <a href="javascript:void(0)" onclick="window.print();" title="Download PDF" class="print-btn btn btn-sm btn-danger">Print</a>
                            </div>
                        </div>
                    </div>
                </div>
